...
Includes custom, fl, font-lock, gnus, message, widget."
  ...
  (color-theme-install
   '(color-theme-darp-laptok
     ...
     (custom-face-tag-face ((t (nn:underline t))))
     ...
     (font-lock-keyword-face ((t (:foreground "MediumPurple2"))))
